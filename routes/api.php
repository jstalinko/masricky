...
Route::get('/user/mutasi/{telegram_id}', [App\Http\Controllers\API\AuthController::class, 'getMutasi'])->name('api.user.getMutasi');
Route::get('/info', [App\Http\Controllers\JustOrangeController::class, 'getInfo'])->name('api.info.getInfo');
...
Route::get('/topup/{nominal}/{telegram_id}', [App\Http\Controllers\API\OrderController::class, 'createTopup'])->name('api.topup.createTopup');
Route::post('/order/create-balance', [App\Http\Controllers\API\OrderController::class, 'createOrderBalance'])->name('api.order.createOrderBalance');

Route::any('/payment/callback', [App\Http\Controllers\API\WebhookController::class, 'webhookInvoice']);
